...
4. Install docker
	4.1. zypper in docker docker-compose sle2docker zypper-docker sles11sp3-docker-image sles12-docker-image sles12sp1-docker-image
...
10. Create SUSE OpenStack Cloud 6 Controller VMs
	...
	10.5. Attach iSCSI LUNs
		10.5.1. Add iSCSI initiator names to Admin server iSCSI client configuration (cat /etc/iscsi/initiatorname.iscsi)
